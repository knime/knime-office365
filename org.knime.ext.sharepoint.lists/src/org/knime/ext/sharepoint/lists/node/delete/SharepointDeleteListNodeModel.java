...
/**
 * SharePoint Online Delete List node implementation of a {@link NodeModel}.
 *
...
final class SharepointDeleteListNodeModel extends NodeModel {
    ...
    protected PortObject[] execute(final PortObject[] inObjects, final ExecutionContext exec) throws Exception {
        ...
        m_client = GraphApiUtil.createClient(credential);
     ...
     * @throws IOException
     */
    private void deleteList() throws ClientException, IOException {
        try {
            m_client.sites(getSiteId())
                    .lists(m_config.getSharepointListSettings().getListSettings().getListModel().getStringValue())
                    .buildRequest().delete();
