...
final class SharepointDeleteListNodeModel extends WebUINodeModel<SharepointDeleteListNodeParameters> {
    ...
    protected PortObjectSpec[] configure(final PortObjectSpec[] inSpecs,
        ...
        if (!params.m_list.hasLoadedLegacyCombinedExistingList()) {
            params.validate();
        } else {
    ...
    private static String getListId(final GraphServiceClient<Request> client, final String siteId,
        ...
        if (listId == null) {
            ...
            } else if (listParameters.hasLoadedLegacyCombinedExistingList() && displayName != null) {
                listName = displayName; // backwards compatibility: will contain both if settings pattern did not match
            } else {
