...
/**
 * SharePoint Online List Updater node config.
 *
 * @author Jannik Löscher, KNIME GmbH, Konstanz, Germany
 */
public final class SharepointListUpdaterConfig {

    private final SharepointListSettings m_sharepointListSettings;

    private static final String CFG_ID_COLUMN = "id_column";

    private SettingsModelColumnName m_idColName;

    SharepointListUpdaterConfig() {
        m_sharepointListSettings = new SharepointListSettings(false, false);
        m_idColName = new SettingsModelColumnName(CFG_ID_COLUMN, "ID");
    }
    ...
    /**
     * @return the name of the column containing the ID to match
     */
    public String getIdColName() {
        return m_idColName.getColumnName();
    }

    /**
     * @return the column containing the ID to match
     */
    public SettingsModelColumnName getIdColNameModel() {
        return m_idColName;
    }
