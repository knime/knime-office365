...
import org.knime.ext.sharepoint.parameters.TimeoutParameters.TimeoutParametersPersistor;
import org.knime.ext.sharepoint.parameters.TimeoutParameters.TimeoutParametersPersistor.MaxSeconds;
...
/**
 * Reusable timeout parameters component for SharePoint nodes. In the parameters
...
@PersistWithin("..")
@Persistor(TimeoutParametersPersistor.class)
public class TimeoutParameters implements NodeParameters {
    ...
    @Widget(title = "Read timeout in seconds", description = """
            Timeout in seconds to read data from an established connection or
    ...
    public void validate() throws InvalidSettingsException {
        CheckUtils.checkSetting(m_readTimeout >= 0, "Please provide a non-negtive read timeout.");
        CheckUtils.checkSetting(m_connectionTimeout >= 0, "Please provide a non-negtive connection timeout.");
