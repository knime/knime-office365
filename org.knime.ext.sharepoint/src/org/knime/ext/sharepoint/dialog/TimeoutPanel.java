 ...
 *
 * History
 *   2021-11-04 (lars.schweikardt): created
 */
...
public final class TimeoutPanel extends JPanel {
    ...
    private void createTimeOutPanel() {
        ...
        final var connectionTimeout = new DialogComponentNumber(m_settings.getConnectionTimeoutModel(), "", 1);
        connectionTimeout.getComponentPanel().setLayout(new FlowLayout(FlowLayout.LEFT));
        final var readTimeout = new DialogComponentNumber(m_settings.getReadTimeoutModel(), "", 1);
        ...
        c.gridx = 1;
        c.gridy = 0;
        add(connectionTimeout.getComponentPanel(), c);

        c.gridy = 1;
        add(readTimeout.getComponentPanel(), c);
        ...
        setBorder(BorderFactory.createTitledBorder("Connection settings"));
    }
    ...
    public void addChangeListener(final ChangeListener listener) {
        m_settings.getConnectionTimeoutModel().addChangeListener(listener);
        m_settings.getReadTimeoutModel().addChangeListener(listener);
    }
