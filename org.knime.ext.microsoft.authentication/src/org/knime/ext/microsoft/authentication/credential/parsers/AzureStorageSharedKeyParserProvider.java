 ...
 * (from KNIME Hub Secret Store) into a {@link AzureStorageSharedKeyCredential}.
 *
 * @author Bjoern Lohrmann, KNIME GmbH
 * @since 5.2.1
 */
public class AzureStorageSharedKeyParserProvider
        extends SecretConsumableParserProvider<AzureStorageSharedKeyCredential> {

    /**
     * Zero-argument default constructor.
     */
    public AzureStorageSharedKeyParserProvider() {
    ...
    private static AzureStorageSharedKeyCredential parse(final Supplier<JsonObject> consumableSupplier)
        ...
        return new AzureStorageSharedKeyCredential(//
                ...
                getStringField(consumable, "sharedKey"));
    }
}
