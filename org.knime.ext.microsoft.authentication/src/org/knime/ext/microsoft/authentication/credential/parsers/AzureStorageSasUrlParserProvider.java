 ...
 */
package org.knime.ext.microsoft.authentication.credential.parsers;
 ...
 * (from KNIME Hub Secret Store) into a {@link AzureStorageSasUrlCredential}.
 *
 * @author Bjoern Lohrmann, KNIME GmbH
 * @since 5.2.1
 */
public class AzureStorageSasUrlParserProvider extends SecretConsumableParserProvider<AzureStorageSasUrlCredential> {

    /**
     * Zero-argument default constructor.
     */
    public AzureStorageSasUrlParserProvider() {
    ...
    private static AzureStorageSasUrlCredential parse(final JsonObject consumable)
        ...
        try {
            ...
            throw new UnparseableSecretConsumableException("Invalid Azure SAS URL:" + e.getMessage(), e);
        }
    }
}
