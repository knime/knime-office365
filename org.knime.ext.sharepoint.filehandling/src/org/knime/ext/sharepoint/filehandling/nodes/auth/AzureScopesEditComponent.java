...
import org.knime.ext.sharepoint.filehandling.auth.data.AzureScopes;

/**
 * Editor component for selecting Azure scopes.
 *
 * @author Alexander Bondaletov
 */
public class AzureScopesEditComponent extends JPanel {
    private static final long serialVersionUID = 1L;

    private SettingsModelStringArray m_scopes;
    private Map<AzureScopes, JCheckBox> m_checkboxes;
     ...
     */
    public AzureScopesEditComponent(final SettingsModelStringArray scopes) {
        m_scopes = scopes;
        m_checkboxes = new EnumMap<>(AzureScopes.class);
        initUI();
    ...
    private void initUI() {
        ...
        for (AzureScopes scope : AzureScopes.values()) {
    ...
    private JCheckBox createCheckbox(final AzureScopes scope) {
    ...
    private void onSelected(final AzureScopes scope, final boolean selected) {
    ...
    private void updateCheckboxes() {
        ...
        for (Entry<AzureScopes, JCheckBox> entry : m_checkboxes.entrySet()) {
