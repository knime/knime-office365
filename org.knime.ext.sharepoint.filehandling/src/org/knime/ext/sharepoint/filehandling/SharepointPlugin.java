...
/**
 * Plugin activate for the Sharepoint plugin.
 *
 * @author Bjoern Lohrmann, KNIME GmbH
 */
public class SharepointPlugin extends AbstractUIPlugin {

    private static final NodeLogger LOG = NodeLogger.getLogger(SharepointPlugin.class);

    // The shared instance.
    private static SharepointPlugin plugin;
     ...
     */
    public static SharepointPlugin getDefault() {
        return plugin;
    }
}