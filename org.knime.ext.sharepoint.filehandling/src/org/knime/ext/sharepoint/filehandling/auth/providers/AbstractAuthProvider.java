...
public abstract class AbstractAuthProvider {
     ...
     */
    protected final AzureConnection m_connection;
     ...
     *
     */
    public AbstractAuthProvider(final AzureConnection connection) {
    ...
    /**
     * Performs authentication and stores authentication info into azure connection
     * object.
     *
