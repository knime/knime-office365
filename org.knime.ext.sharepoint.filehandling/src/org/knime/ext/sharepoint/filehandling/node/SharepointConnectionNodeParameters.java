...
/**
 * Node parameters for the SharePoint Online Connector node.
 *
...
final class SharepointConnectionNodeParameters implements NodeParameters {
    ...
    SharepointFSConnectionConfig toFSConnectionConfig(final IAuthenticationProvider authProvider) {
        final var workingDir = m_workingDirectory.isEmpty() ? SharepointFileSystem.PATH_SEPARATOR : m_workingDirectory;

        final var config = new SharepointFSConnectionConfig(workingDir, authProvider);
