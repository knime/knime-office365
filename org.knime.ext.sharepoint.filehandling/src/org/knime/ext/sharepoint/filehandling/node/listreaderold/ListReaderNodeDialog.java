 ...
 */
final class ListReaderNodeDialog extends NodeDialogPane {
    ...
    private FSConnection createFSConnection() throws IOException {
        final ListReaderNodeSettings clonedSettings = m_settings.clone();
        return new SharepointFSConnection(clonedSettings
                .toFSConnectionConfig(ListReaderNodeModel.createGraphAuthProvider(m_connection)));
    }
