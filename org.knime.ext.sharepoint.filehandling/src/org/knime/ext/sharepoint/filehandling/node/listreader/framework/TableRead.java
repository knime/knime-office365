...
import org.knime.ext.sharepoint.filehandling.node.listreader.table.BoundedTable;
...
public class TableRead implements Read<DataValue> {
    ...
    static class RandomAccessibleDataRow extends AbstractRandomAccessible<DataValue> {
        ...
        private TableReadConfig<SharepointListReaderConfig> m_config;

        RandomAccessibleDataRow(final DataRow dataRow, final TableReadConfig<SharepointListReaderConfig> config) {
            m_row = dataRow;
            m_config = config;
        }
     ...
     */
    public TableRead(final Table input, final TableReadConfig<SharepointListReaderConfig> config) {
