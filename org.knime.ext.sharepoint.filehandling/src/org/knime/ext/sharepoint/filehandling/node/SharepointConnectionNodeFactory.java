...
/**
 * Factory class for SharePoint Online Connector Node.
 *
...
public class SharepointConnectionNodeFactory extends NodeFactory<SharepointConnectionNodeModel>
    ...
    private static final String NODE_NAME = "SharePoint Online Connector";
    ...
    private static final String FULL_DESCRIPTION = """
            <p>
                This node connects to a SharePoint Online site. The resulting output port allows downstream
                nodes to access the <i>document libraries</i> of the site as a file system, e.g. to read or write
                files and folders,
