 ...
 */
public abstract class AbstractSharepointSettings implements Cloneable {
    ...
    protected AbstractSharepointSettings() {
        ...
        m_connectionTimeout = new SettingsModelIntegerBounded(KEY_CONNECTION_TIMEOUT,
                SharepointFSConnectionConfig.DEFAULT_TIMEOUT, 0, Integer.MAX_VALUE);
        m_readTimeout = new SettingsModelIntegerBounded(KEY_READ_TIMEOUT, SharepointFSConnectionConfig.DEFAULT_TIMEOUT,
                0, Integer.MAX_VALUE);
    }
    ...
    protected void validateSettings(final NodeSettingsRO settings) throws InvalidSettingsException {
        ...
        var temp = new SharepointConnectionSettings();
     ...
     * @throws InvalidSettingsException
     */
    protected void validate() throws InvalidSettingsException {
     ...
     */
    protected SiteSettings getSiteSettings() {
     ...
     */
    protected SettingsModelIntegerBounded getReadTimeoutModel() {
    ...
    @Override
    public abstract AbstractSharepointSettings clone();
